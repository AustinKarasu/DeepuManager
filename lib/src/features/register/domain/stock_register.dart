class StockRegister {
  ...
  factory StockRegister.fromApi(Map<String, Object?> map) => StockRegister(
        id: map['id'] as String,
        ...
        particulars: map['particulars'] as String,
        openingQty: (map['openingQty'] as num).toDouble(),
        openingRate: (map['openingRate'] as num).toDouble(),
        openingAmount: (map['openingAmount'] as num).toDouble(),
        receiptQty: (map['receiptQty'] as num).toDouble(),
        receiptRate: (map['receiptRate'] as num).toDouble(),
        receiptAmount: (map['receiptAmount'] as num).toDouble(),
        totalQty: (map['totalQty'] as num).toDouble(),
        totalRate: (map['totalRate'] as num).toDouble(),
        totalAmount: (map['totalAmount'] as num).toDouble(),
        issueQty: (map['issueQty'] as num).toDouble(),
        issueRate: (map['issueRate'] as num).toDouble(),
        issueAmount: (map['issueAmount'] as num).toDouble(),
        closingQty: (map['closingQty'] as num).toDouble(),
        closingAmount: (map['closingAmount'] as num).toDouble(),
